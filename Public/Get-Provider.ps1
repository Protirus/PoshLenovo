<#
.SYNOPSIS
  Gets Provider Object from Lenovo API.
...
.FUNCTIONALITY
   Get-Provider is intended to function as a mechanism for getting Provider Object from the Lenovo API.
#>
...
function Get-Provider-ServiceProviders
{
    <#
    .PARAMETER ProductId
...
#region Execution
#-----------------------------------------------------------[Execution]------------------------------------------------------------
$response = Get-Provider-ServiceProviders
$response
